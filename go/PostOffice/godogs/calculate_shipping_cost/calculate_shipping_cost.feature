Feature: Shipping cost calculation based on delivery type
  Scenario: Calculate shipping cost for a valid package with different delivery types
    ...
    Examples:
      ...
      | 30     | 30    | 30     | 4.0    | STANDARD     | 75.0         |
      | 30     | 30    | 30     | 4.0    | EXPRESS      | 135.0        |
      | 30     | 30    | 30     | 4.0    | ECONOMY      | 45.0         |
